...
class StudentController extends Controller
{
    ...
    public function store(Request $request, $student_parent_id)
    {
        ...
        $rules = [
            'StudentNameSurname' => 'required|max:50'
        ];
        ...
        if($validator->fails()){
            ...
            $student->name_surname = $data[0]["StudentNameSurname"];
    ...
    public function update(Request $request, $student_id)
    {
        ...
        if($validator->fails()){
            ...
            $grade= Student::find($student_id)->update(['name_surname' => $data[0]["StudentNameSurname"]]);
